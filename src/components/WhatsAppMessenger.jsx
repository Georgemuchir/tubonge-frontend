...
const ConversationsView = ({ conversations, inboxLoading, onSelectUser, onNewMessage, _onOpenSidebar, _isMobile, searchQuery, setSearchQuery, resolveMediaUrl, _user, onDelete, onMute, onArchive, mutedIds, archivedIds, onLogout }) => {
...
const WhatsAppMessenger = () => {
  ...
  const [_showMobileSidebar, setShowMobileSidebar] = useState(false);
